    ...
    const work = [
        {
            ...
            link: 'https://uxerp.ultra-x.jp/dashboard',
        },
        {
            name: 'Full Stack Project',
            icon: './assets/work-2.png',
            description: 'Web Project',
            link: 'https://bdtmp.ultra-x.jp/ems/en/login',
        },
        {
            name: 'Full Stack Project',
            icon: './assets/work-3.png',
            description: 'Web Project',
            link: 'https://bdtmp.ultra-x.jp/crm/en/home',
        },
        // {
                    ...
                    <div key={work.name} className="aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group" style={{ backgroundImage: `url(${work.icon})` }}>
                        <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
                            ...
                            <a
                                ...
                                >
                                <img src="./assets/send-icon.png" alt="Visit project" className="w-5" />
                            </a>
                        </div>
                    </div>
                ))}
